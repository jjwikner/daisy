...
;;; $Id: spice-mode.el,v 1.93 2003/03/29 00:03:21 vdplas Exp vdplas $

;; Emacs Lisp Archive Entry
;; Author: Geert A. M. Van der Plas <geert_vanderplas@email.com> 1999-2003
;;         Emmanuel Rouat <emmanuel.rouat@wanadoo.fr> 1997-2003 
...
;; use customization to modify the behaviour of spice-mode or add 
...
(defconst spice-version "1.2.23 (29 Mar 2003)"
  ...
  (setq spice-font-lock-keywords-11
	(list 
	 ...
	 (list 'spice-match-variable-name 
	       ...
	       '(2 'default)) ;; default is required for XEmacs
	 ;;  )
...
(if spice-mode-map
  ...
  (let ((map (make-sparse-keymap)))  
    ...
    (define-key map "\C-cs"    'spice-compile)
    ...
    (define-key map "\C-cv"    'spice-run-waveform-viewer)
    
    ;; key bindings for output file loading
    (define-key map "\C-co"    'spice-load-output-file)
    
    ;; key bindings for include file loading
    (define-key map "\C-cl"    'spice-load-include-files)
    
    ;; comment region, use auctex-mode bindings...
    (define-key map "\C-c;"    'comment-region)
    (define-key map "\C-c:"    'spice-uncomment-region)
    ...
    (define-key map "\C-ch"    'spice-hide-all-comments)
    (define-key map "\C-c\C-h" 'spice-unhide-all-comments)

    ;; changelog addition
    (define-key map "\C-cac"   'spice-add-changelog-entry)
...
(defun spice-get-simulator ()
  ...
  (if (and spice-simulator
	   (assq spice-simulator spice-simulator-alist))
...
(defun spice-get-waveform-viewer ()
  ...
  (if (and spice-waveform-viewer
	   (assq spice-waveform-viewer spice-waveform-viewer-alist))
...
<<< test.cir ends here >>>
   ...
   - Works under GNU Emacs20.6/21.[12], also tested under XEmacs21.1/21.4.5,
