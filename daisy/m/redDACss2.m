function [output]=redDACss2(fs, Inom, Vini, R, Co, Ri, Rsi, Ci, Vterm)

% [output]=redDACss2(fs, Inom, Vini, R, Co, Ri, Rsi, Ci, Vterm)
...
% Vterm is the voltage at the downside of the load resistance (often 0).
...
T=1/fs;
output=expm(A*T)*Vini'+A\(expm(A*T)*B-B)+Vterm;
