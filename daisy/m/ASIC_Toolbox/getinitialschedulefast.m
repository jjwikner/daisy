function [schedule]=getinitialschedulefast(sfg,latency,executiontime,scheduletime)
% Produces the Computation Graph for a given SFG
% latency and execution time are positive real numbers
...
[starttime,lat_vec,exe_vec,endtime,criticalpath,numberoflaps]=get_timinginfo(sfg,latency,executiontime);
