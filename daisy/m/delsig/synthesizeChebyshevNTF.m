...
%ntf = synthesizeChebyshevNTF(order=3,OSR=64,H_inf=1.5,f0=0)
...
% !!! BANDPASS MODULATORS NOT YET SUPPORTED
%
...
if( f0 ~= 0 )
    fprintf(1,'Sorry, bandpass modulators are not yet supported.\n');
    return;
end
