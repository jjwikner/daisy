function [readData,waveNames, waveUnits] = readOcnPrint(fileName, numberOfSignals);
%
% function [readData] = readOcnPrint(filename, numberOfSignals);
% 
% Function that reads the specialized format from cadence ocnPrint dump.
%
% numberOfSignals : Expected number of signals in the file
%                   (This can be calculated automatically, but 
%                    left for future improvement). Be precise though!
% fileName        : Name of the file from the ocnPrint command.  
% 
